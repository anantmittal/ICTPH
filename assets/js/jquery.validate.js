...
$.extend($.validator, {
	...
	messages: {
		...
		alphanum: "Only alphabets and numbers are allowed.",
		check_dateFormat: "Date must be in DD/MM/YYYY format.",
	...
	classRuleSettings: {
		...
		email: {email: true},
		check_dateFormat: {check_dateFormat: true},
		url: {url: true},
		date: {date: true},
	...
	methods: {
		...
		check_dateFormat: function(value, element) {
