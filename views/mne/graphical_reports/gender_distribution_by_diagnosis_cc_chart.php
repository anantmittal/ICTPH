...
var report_filters = {
					...
					"chief_complaint":<?php echo json_encode($chief_complaint_list);?>,
	...
	<div id="report_details_box"> 
		...
		<div class="blue_left">
	 	...
	 	<div class="blue_body" style="padding:8px;">
			...
			<center>
     			<a href="javascript: void(0);" onclick="gender_distribution_by_diagnosis_cc_chart_ajax()">Create Report</a>
     			</center>
