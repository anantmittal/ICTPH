...
<td colspan="2" align="center" valign="middle"><h4>Please Enter From and To dates For Visit Report Generation.</h4> </td>
     <tr>
     <td><b>From Date</b> </td>
     <td>
...
<tr>	
	<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="submit" name="get_report" value="Create Visit Report"> </td>
	</tr>
<?php	
	if(isset($visit_filename))
	{ ?>
  <tr class="row">
   <td colspan="4" > <a href="<?php echo $this->config->item('base_url').'/uploads/visits/'.$visit_filename;?>"> Visits file has been created. Click here to download. </a> </td>
  </tr>
  <tr class="row">
   <td colspan="4" > <a href="<?php echo $this->config->item('base_url').'/uploads/visits/'.$summary_filename;?>"> Summary file has been created. Click here to download. </a> </td>
  </tr>
<?php } ?>
</table>
</form>
