...
<meta name="GENERATOR" content="Zend Studio" />
    ...
    <title>Preconsultation Lists</title> 
...
<div class="green_left"><div class="green_right">
    	  <div class="green_middle"><span class="head_box">List of Pre-consultation / PISP for patients on <?php echo $date;?></span></div></div></div>
...
<div class="green_body">
	    <table  width="970px" border="1px" cellspacing="2" cellpadding="2" id="stock_table">
		      <tr class="head">
					...
					<td width="97px">List Visits</td>
					<td width="145px">Add diagnostic Visit</td>
					<td width="97px">Add visit</td>
		      ...
		      <tr>
					...
					<td><a href="<?php echo $this->config->item('base_url').$list_visit_url.$values[$i]['person_id'].'/'.$values[$i]['policy_id']; ?>">List Visit</a></td>
					<td><a href="<?php echo $this->config->item('base_url').$add_visit_url.$values[$i]['person_id'].'/'.$values[$i]['policy_id'].'/Diagnostic'; ?>">Add Diagnostic Visit</a></td>
					<td><a href="<?php echo $this->config->item('base_url').$add_visit_url.$values[$i]['person_id'].'/'.$values[$i]['policy_id']; ?>">Add Visit</a></td>
					<td>
					 <?php echo $values[$i]['type'];?>
					</td>
		      </tr>
		      <?php } ?>
