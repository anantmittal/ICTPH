...
<td colspan="2" align="center" valign="middle"><h4>Please Enter From and To dates For Generating Inventory Variance Report.</h4> </td>
     <tr>
     <td><b>From Date</b> </td>
     <td>
...
<?php	
	...
	{ ?>
  <tr class="row">
   		<td colspan="4" > <a href="<?php echo $this->config->item('base_url').'/uploads/mne/'.$report_filename;?>"> Report generated. Click here to download. </a> </td>
  </tr>
