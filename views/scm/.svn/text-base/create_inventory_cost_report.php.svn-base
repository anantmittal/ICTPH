...
<title>Total Inventory Cost Report </title>
...
<form method="POST">
	<table align="center" border="1">
		<td colspan="2" align="center" valign="middle"><h4>Enter From and To dates For Generating Total Inventory Cost Report.</h4> </td>
		     <tr>
		     <td><b>From Date</b> </td>
		     <td>
