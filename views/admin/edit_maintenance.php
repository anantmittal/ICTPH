	...
	<div id="main">
		...
		<div id="leftcol">
			...
			<div class="yelo_body" style="padding: 8px;">
				...
				<div class="action_items" style="font-weight: bold"><a href="<?php echo $this->config->item('base_url');?>index.php/admin/consumables_configuration/find_maintenance/edit">Edit Maintenance</a></div>
			...
			<div class="blue_left">
				<div class="blue_right">
					<div class="blue_middle">
						<span class="head_box">Edit Maintenance</span>
					</div>
				</div>
			</div>
			<div class="blue_body" style="padding: 8px;">
				<form id = "find_maintenance_form" method="post" onSubmit="return onFindMaintenanceSubmit('<?php echo $this->config->item('base_url')?>');">
								<?php $this->load->view('admin/find_maintenance.php'); ?>
								
				</form>
				<form method="POST" id="add_maintenance_table"
								action="<?php echo $this->config->item('base_url').'index.php/admin/consumables_configuration/stock_maintenance/edit'?>"
								onSubmit="return ValidateConsumable()">
					<table width="600" border="0" align="center" cellpadding="5"
						cellspacing="1" class="data_table" >
							<?php 
								if(isset($edit_maintenance)){
									$this->load->view('admin/add_edit_maintenance.php');
							 }?>
