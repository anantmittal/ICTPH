	...
	<div id="main">
		...
		<div id="leftcol">
			...
			<div class="yelo_body" style="padding: 8px;">
				...
				<div class="action_items" style="font-weight: bold"><a href="<?php echo $this->config->item('base_url');?>index.php/admin/consumables_configuration/add_service">Add Service</a></div>
			...
			<div class="blue_left">
				<div class="blue_right">
					<div class="blue_middle">
						<span class="head_box">Add Service</span>
					</div>
				</div>
			</div>
			<div class="blue_body" style="padding: 8px;">
				<form method="POST" id="add_service_table" action="<?php echo $this->config->item('base_url').'index.php/admin/consumables_configuration/service/add'?>" onSubmit="return ValidateConsumable()">
					<table width="600" border="0" align="center" cellpadding="5" cellspacing="1" class="data_table" >
						<?php $this->load->view('admin/add_edit_service.php');?>
					</table>
					</form>
					<br />
