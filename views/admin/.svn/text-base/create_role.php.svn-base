...
<div id="main">
  ...
  <div id="leftcol">
		...
		<div class="yelo_body" style="padding:8px;">
		    ...
		    <div class="action_items" style="font-weight:bold" > <a href="<?php echo $this->config->item('base_url');?>index.php/admin/user_management/create_role">Create Role</a></div>
		...
		<div class="blue_left">
			<div class="blue_right">
				<div class="blue_middle">
					<span class="head_box">Create Role</span>
				</div>
			</div>
		</div>
		<div class="blue_body" style="padding:8px;">
			<form method="POST" action="<?php echo $this->config->item('base_url').'index.php/admin/user_management/create_role'?>"
			onSubmit="return validateCreateRoleForm()" >
				<?php $this->load->view('admin/create_edit_role_form.php'); ?>
			</form>
		</div>
