...
<title>Create Report CSV file / Html </title>
...
<form action="create_report_csv" method="POST">
<table align="center" border="1">
<td colspan=2 align="center" valign="middle"><h4>Please Enter Policy End Date  For getting report file.</h4> </td>
	<tr>
