...
<?php 
  ...
  <tr class="row">
    ...
    <td width="25%" > <?php echo $values[$i]['hof_name']; ?> </td>
    <td width="30%" > <?php echo $values[$i]['address']; ?> </td>
    <td width="5%" > <?php echo $values[$i]['family_size']; ?> </td>
  </tr>
<?php  } ?>

	      <?php if (isset($other_actions)) { ?>
	      <tr>
	...
	</div><div class="greenbtm_left"><div class="greenbtm_right"><div class="greenbtm_middle"></div></div></div>
	</div></div>
<?php } ?>
<!--Body Ends-->
