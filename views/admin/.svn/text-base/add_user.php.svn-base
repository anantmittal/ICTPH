...
<div id="main">
  ...
  <div id="leftcol">
		...
		<div class="yelo_body" style="padding:8px;">
		    ...
		    <div class="action_items" style="font-weight:bold"> <a href="<?php echo $this->config->item('base_url');?>index.php/admin/user_management/add_user">Add User</a></div>
	...
	<div id="rightcol">
		<div class="blue_left">
			<div class="blue_right">
				<div class="blue_middle">
					<span class="head_box">Add User</span>
				</div>
			</div>
		</div>
		<div class="blue_body" style="padding:8px;">
			...
			onSubmit="return validateAddUserForm()" >
				<?php $this->load->view('admin/add_edit_form.php'); ?>
			</form>
		</div>
