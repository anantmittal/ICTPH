	...
	<div id="main">
		...
		<div id="leftcol">
			...
			<div class="yelo_body" style="padding: 8px;">
				...
				<div class="action_items" style="font-weight: bold"><a href="<?php echo $this->config->item('base_url');?>index.php/admin/consumables_configuration/add_test_group">Add Test Group</a></div>
			...
			<div class="blue_left">
				<div class="blue_right">
					<div class="blue_middle">
						<span class="head_box">Add Test Group</span>
					</div>
				</div>
			</div>
			<div class="blue_body" style="padding: 8px;">
				<form method="POST"  action="<?php echo $this->config->item('base_url').'index.php/admin/consumables_configuration/test_groups/add'?>" onSubmit="return ValidateTestGroup()">
					<table width="600" border="0" align="center" cellpadding="5" cellspacing="1" class="data_table" >
						<?php $this->load->view('admin/add_edit_test_group.php');?>
					</table>
					</form>
					<br />
