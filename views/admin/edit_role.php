...
<div id="main">
  ...
  <div id="leftcol">
		...
		<div class="yelo_body" style="padding:8px;">
		    ...
		    <div class="action_items" style="font-weight:bold" > <a href="<?php echo $this->config->item('base_url');?>index.php/admin/user_management/find_role/edit_role">Edit Role</a></div>
		...
		<div class="blue_left">
			<div class="blue_right">
				<div class="blue_middle">
					<span class="head_box">Edit Role</span>
				</div>
			</div>
		</div>
		<div class="blue_body" style="padding:8px;">
		<form id = "find_role_form" method="post" onSubmit="return onFindRole('<?php echo $this->config->item('base_url')?>');">
		<?php $this->load->view('admin/find_role.php'); ?>
		</form>
	
	   	<form method="POST" action="<?php echo $this->config->item('base_url').'index.php/admin/user_management/update_role'?>" onSubmit="return editRoleValidate();">		
			
		<?php 
			if(isset($edit_role)){
				$this->load->view('admin/create_edit_role_form.php');				
			}
		?>
		</form>
