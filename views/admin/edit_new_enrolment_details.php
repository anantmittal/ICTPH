...
<form action="<?php echo $this->config->item('base_url').'index.php/admin/enrolment/enroll_new_household_members/'.$policy_number.'/'.$action; ?>" method="POST">
...
<!-- ALA
   <tr class="row">
	...
	<td>Area<?php echo form_dropdown("add_area", $areas, $area_id, 'class="bigselect"'); ?></td>
   </tr> -->
   <tr class="row">
   ...
   <tr class="row">
     ...
     <td>Family Size
     <input type="hidden" name="no_of_lives" size=2 maxlength=2 value="<?php echo $no_of_lives;?>"/> <?php echo $no_of_lives;?></td>
   </tr>
...
<?php 
  ...
  <tr class="row">
    ...
    <td width="30%"> 
       <input type="text" name="member<?php echo $i;?>_name" size=35 value="<?php echo $member->full_name; ?>" /> 
    </td>
    ...
    <td width="9%">
     <?php echo form_dropdown('member'.$i.'_relation', $relations, $member->relation, 'class="bigselect"'); ?>
    </td>
