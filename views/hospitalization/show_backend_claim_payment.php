 ...
 <?php echo $values['payment_received_date'];?></div>
	...
	&nbsp;
          ...
          <div class="form_row">
              ...
              <div class="form_right">
  <input name="cheque_received_date" id="cheque_received_date" type="text" value="<?php echo $values['cheque_received_date'];?>" class="datepicker check_dateFormat"  style="width:140px;"  />&nbsp;</div> <div style="font-size:12px;color:red;" id="error_payment_received_date"> </div>  <br /><div style="padding-left:250px;padding-right:300px;">( eg: DD/MM/YYYY )</div>
            </div>
	&nbsp;
            ...
            <div class="form_leftB">Cheque Deposited by</div>
              <div class="form_right">
                <input name="cheque_deposited_by" type="text" size="25" class="required" value="<?php echo $values['cheque_deposited_by']; ?>" />
