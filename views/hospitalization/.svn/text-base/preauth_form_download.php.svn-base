...
<title>Preautherization Form Download</title>
...
<div id="main">
  ...
  <div class="hospit_box">
    	<div class="green_left"><div class="green_right">
    	  <div class="green_middle"><span class="head_box">Preautherization</span></div></div></div>
       ...
       <div id="right_col">
    	<div class="blue_left"><div class="blue_right">
    	  <div class="blue_middle"><span class="head_box">Preautherization form download</span></div></div></div>
          <div class="blue_body">

  <div class="form_row">
    <div class="form_leftB">Preautherization Created for </div>
   <div class="form_right"> <a href="<?php echo $this->config->item('base_url').'/uploads/preauths/'.$filename;?>">  Click here to download. </a> </div>
  </div>
